...
class CalendarPickerDataSourceFactory : DataSource.Factory<Calendar, CalendarPickerDto>() {
    ...
    override fun create(): DataSource<Calendar, CalendarPickerDto> {
        ...
        return object : PageKeyedDataSource<Calendar, CalendarPickerDto>() {
            override fun loadInitial(params: LoadInitialParams<Calendar>, callback: LoadInitialCallback<Calendar, CalendarPickerDto>) {
                ...
                val list = (0 until params.requestedLoadSize)
                        ...
                        .flatMap {
                            ...
                            (1..maximum).forEach { day -> list.add(DayDto(firstDayOfMonth.copy().apply { set(Calendar.DATE, day) })) }
                            val lastDayOfWeek = firstDayOfMonth.copy().apply { set(Calendar.DATE, maximum) }.get(Calendar.DAY_OF_WEEK)
            ...
            override fun loadBefore(params: LoadParams<Calendar>, callback: LoadCallback<Calendar, CalendarPickerDto>) {}
